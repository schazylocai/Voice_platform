...
video_url_ara = "https://youtu.be/xBUGO2e-3EI"
...
def write_Arabic_About():
    ...
    with col2:
        ...
        change_text_style_arabic(
            "يمكنك الآن التفاعل بسهولة مع المستندات أو المواقع الإلكترونية أو موقع يوتيوب بشكل لم يسبق له مثيل بفضل هذه المنصة المتقدمة.",
            'subhead', violet)
        st.markdown("")
        change_text_style_arabic(
