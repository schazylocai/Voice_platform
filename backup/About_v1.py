    ...
    def intro():
        ...
        def Terms():
            ...
            with st.expander(":violet[Q&A / Tips]"):
                ...
                st.caption("• Increased productivity: GPT-Doc Analyzer can help you to save time by automating the process of analyzing and summarizing documents.")
                st.caption("• Improved accuracy: GPT-Doc Analyzer can help you to produce more accurate summaries by identifying the most important information in a document.")
                st.caption("• Better insights: GPT-Doc Analyzer can help you to gain new insights into documents by identifying patterns and relationships in the text.")
                ...
                st.caption("• If you are not sure if a document is suitable for GPT-Doc Analyzer, try uploading a small portion of it first.")
